...
class Player(Sprite):
    def __init__(
        ...
        self.__post_init__()
        self.group_list[0].add(self) # add in camera group
        self.group_list[1].add(self) # add in player group
    ...
    def shot(self):
        for value in self.pos_weapons_rotation:
            ...
            self.group_list[2].add(shot) # player shot_group
